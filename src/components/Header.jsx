    ...
    return (
        <header className="main-header">
            ...
            <nav className="header-menu">
                {roleName === 'CUSTOMER' && (
                    <>
                        <Link to="/" className="menu-item active"><i className="fa-solid fa-house"></i> Trang chủ</Link>
                        ...
                        <Link to="/order-history" className="menu-item"><i className="fa-solid fa-clipboard-list"></i> Lịch sử đơn hàng</Link>
                    </>
                )}

                {roleName === 'ADMIN' && (
                    <>
                        <Link to="/dashboard" className="menu-item active"><i className="fa-solid fa-gauge-high"></i> Dashboard</Link>
                        <span className="menu-divider"></span>
                        
                        <Link to="/admin/orders" className="menu-item"><i className="fa-solid fa-boxes-stacked"></i> Quản lý đơn hàng</Link>
                        <span className="menu-divider"></span>
            ...
            <div className="header-bottom">
                ...
                {roleName !== 'ADMIN' && (
                    <form className="search-box" action="/categories" method="get">
                        <input className="search-input" type="text" name="keyword" placeholder="Tìm kiếm linh kiện..." />
                    ...
                    {account ? (
                        <div className="user-dropdown">
                            ...
                            <div className="dropdown-menu">
                                <Link to="/profile"><i className="fa-regular fa-id-card"></i> Thông tin cá nhân</Link>
                                <a href="#" onClick={handleLogout} className="menu-item logout"><i className="fa-solid fa-right-from-bracket"></i> Đăng xuất</a>
                            </div>
                        </div>
                    ) : (
